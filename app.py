...
def main():
    ...
    if choice == 'Home':
        ...
        image = Image.open('VolatilityPredictorApp.png')
...
""")
        ...
        image = Image.open('PerformanceApresTuningEnSurlignage.png')
        st.image(image, use_column_width=True)
        st.subheader('Model validation curve')
        image = Image.open('ValidationCurveV2.png')
        st.image(image, use_column_width=True)
        st.subheader("Model learning curve")
        image = Image.open('LearningCurveV2.png')
        st.image(image, use_column_width=True)
        st.subheader("Prediction on the validation dataset")
        image = Image.open('PredictionAfterTuned.png')
        st.image(image, use_column_width=True)
        st.subheader("The most important variables of the model")
        image = Image.open('FeatureImportance.png')
        st.image(image, use_column_width=True)
